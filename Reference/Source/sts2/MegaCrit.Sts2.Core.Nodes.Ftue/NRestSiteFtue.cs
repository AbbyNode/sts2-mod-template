...
public class NRestSiteFtue : NFtue
{
	...
	public new class PropertyName : NFtue.PropertyName
	{
		...
		public static readonly StringName _restSiteOptionContainer;
	...
	public static extern NRestSiteFtue? Create(Control restSiteOptionContainer);
