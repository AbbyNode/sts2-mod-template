...
public class NCombatRewardFtue : NFtue
{
	...
	public static extern NCombatRewardFtue? Create(Control rewardsContainer);

	[AsyncStateMachine(typeof(_003CWaitForPlayerToConfirm_003Ed__10))]
	...
	public extern NCombatRewardFtue();
}
