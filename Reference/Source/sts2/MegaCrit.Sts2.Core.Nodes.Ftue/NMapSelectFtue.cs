...
public class NMapSelectFtue : NFtue
{
	...
	public new class PropertyName : NFtue.PropertyName
	{
		...
		public static readonly StringName _ftuePosition;

		public static readonly StringName _firstNode;
	...
	public static extern NMapSelectFtue Create(Control roomNode);

	[AsyncStateMachine(typeof(_003CWaitForPlayerToConfirm_003Ed__11))]
	public extern Task WaitForPlayerToConfirm();
