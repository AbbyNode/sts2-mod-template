...
public sealed class PhantasmalGardener : MonsterModel
{
	...
	public extern int EnlargeTriggers { get; set; }

	public override extern bool ShouldFadeAfterDeath { get; }

	public extern float CurrentScale
	{
		[CompilerGenerated]
		get;
	}
	...
	[AsyncStateMachine(typeof(_003CAfterAddedToRoom_003Ed__37))]
	...
	public extern PhantasmalGardener();
}
