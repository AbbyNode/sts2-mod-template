...
public sealed class PunchConstruct : MonsterModel
{
	...
	public extern bool StartsWithStrongPunch { get; set; }

	public extern int StartingHpReduction { get; set; }

	[AsyncStateMachine(typeof(_003CAfterAddedToRoom_003Ed__24))]
