...
public class NScratchVfx : Node2D
{
	...
	public static extern NScratchVfx? Create(Creature creature, bool goingRight);

	public static extern NScratchVfx? Create(Vector2 targetCenterPosition, bool goingRight);
