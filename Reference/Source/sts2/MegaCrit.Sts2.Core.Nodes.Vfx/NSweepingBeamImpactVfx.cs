...
public class NSweepingBeamImpactVfx : Node2D
{
	...
	public static extern NSweepingBeamImpactVfx? Create(Creature creature);

	public static extern NSweepingBeamImpactVfx? Create(Vector2 targetCenter);
	...
	public extern NSweepingBeamImpactVfx();
}
