...
public class NGoopyImpactVfx : Node2D
{
	...
	public static extern NGoopyImpactVfx? Create(Creature creature);

	public static extern NGoopyImpactVfx? Create(Vector2 targetCenterPosition, Color tint);
