...
public class NDeckViewScreen : NCardsViewScreen
{
	public new class MethodName : NCardsViewScreen.MethodName
	{
		...
		public new static readonly StringName AfterCapstoneClosed;

		public static readonly StringName OnPileContentsChanged;

		public static readonly StringName OnObtainedSort;
		...
		public static readonly StringName DisplayCards;
	...
	public new class PropertyName : NCardsViewScreen.PropertyName
	{
		...
		public static readonly StringName _obtainedSorter;
	...
	public static extern NDeckViewScreen? ShowScreen(Player player);
	...
	public override extern void AfterCapstoneClosed();
