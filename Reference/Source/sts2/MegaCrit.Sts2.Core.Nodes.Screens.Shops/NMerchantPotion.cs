...
public class NMerchantPotion : NMerchantSlot
{
	...
	public new class PropertyName : NMerchantSlot.PropertyName
	{
		...
		public static readonly StringName _potionNodePosition;
	...
	public extern void FillSlot(MerchantPotionEntry potionEntry);

	protected override extern void UpdateVisual();

	[AsyncStateMachine(typeof(_003COnTryPurchase_003Ed__12))]
