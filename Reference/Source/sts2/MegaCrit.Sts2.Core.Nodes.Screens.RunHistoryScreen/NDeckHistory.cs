...
public class NDeckHistory : VBoxContainer
{
	...
	public extern void LoadDeck(Player player, IEnumerable<SerializableCard> cards);
	...
	protected extern void EmitSignalHovered(NDeckHistoryEntry deckHistoryEntry);

	protected extern void EmitSignalUnhovered(NDeckHistoryEntry deckHistoryEntry);
