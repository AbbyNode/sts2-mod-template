...
public class PotionReward : Reward
{
	...
	public extern PotionModel? ClaimedPotion
	{
		[CompilerGenerated]
		get;
	}
	...
	public extern PotionReward(Player player);

	public extern PotionReward(PotionModel potion, Player player);

	public override extern Task Populate();

	public override extern Control? CreateIcon();

	[AsyncStateMachine(typeof(_003COnSelect_003Ed__26))]
