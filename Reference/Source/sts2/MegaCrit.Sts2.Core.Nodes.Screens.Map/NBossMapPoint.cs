...
public class NBossMapPoint : NMapPoint
{
	...
	public new class PropertyName : NMapPoint.PropertyName
	{
		...
		public static readonly StringName _usesSpine;

		public static readonly StringName _spriteContainer;

		public static readonly StringName _spineSprite;

		public static readonly StringName _material;

		public static readonly StringName _placeholderImage;

		public static readonly StringName _placeholderOutline;
	...
	public static extern NBossMapPoint Create(MapPoint point, NMapScreen screen, IRunState runState);
