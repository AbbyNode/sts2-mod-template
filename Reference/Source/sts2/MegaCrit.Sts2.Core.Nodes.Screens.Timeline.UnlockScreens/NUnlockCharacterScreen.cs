...
public class NUnlockCharacterScreen : NUnlockScreen
{
	...
	public new class PropertyName : NUnlockScreen.PropertyName
	{
		...
		public static readonly StringName _spineAnchor;
	...
	public static extern NUnlockCharacterScreen Create(EpochModel epoch, CharacterModel character);
	...
	public extern NUnlockCharacterScreen();
}
