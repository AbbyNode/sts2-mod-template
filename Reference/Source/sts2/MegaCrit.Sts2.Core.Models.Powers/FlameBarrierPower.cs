...
public sealed class FlameBarrierPower : PowerModel
{
	...
	public override extern Task AfterDamageReceived(PlayerChoiceContext choiceContext, Creature target, DamageResult _, ValueProp props, Creature? dealer, CardModel? __);
	...
	public extern FlameBarrierPower();
}
