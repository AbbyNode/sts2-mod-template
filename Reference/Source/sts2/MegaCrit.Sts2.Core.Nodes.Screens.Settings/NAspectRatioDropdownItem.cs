...
public class NAspectRatioDropdownItem : NDropdownItem
{
	...
	{
		public static readonly StringName aspectRatioSetting;
	...
	public extern void Init(AspectRatioSetting setAspectRatioSetting);
	...
	public extern NAspectRatioDropdownItem();
}
